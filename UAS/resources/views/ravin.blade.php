...
<section class="text-gray-400 bg-gray-900 body-font">
    ...
    <div class="container px-5 py-24 mx-auto">
        <h1 class="sm:text-3xl text-2xl font-medium title-font text-center text-white mb-20">Jadwal Misa
            <br class="hidden sm:block">Gereja Santo Barnabas
        </h1>
        <div class="-my-8 divide-y-2 divide-gray-800">
        <div class="py-8 flex flex-wrap md:flex-nowrap">
            <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
            <span class="font-semibold title-font text-white">Misa Harian</span>
            <span class="mt-1 text-gray-500 text-sm">Gereja Katolik Santo Barnabas</span>
            </div>
            <div class="md:flex-grow">
            <h2 class="text-2xl font-medium text-white title-font mb-2">Jam 06.00 WIB</h2>
        ...
        <div class="py-8 flex border-t-2 border-gray-800 flex-wrap md:flex-nowrap">
            <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
            <span class="font-semibold title-font text-white">Misa Jumat Pertama</span>
            <span class="mt-1 text-gray-500 text-sm">Gereja Katolik Santo Barnabas</span>
            </div>
            <div class="md:flex-grow">
            <h2 class="text-2xl font-medium text-white title-font mb-2">Jam 18.00 WIB</h2>
        ...
        <div class="py-8 flex border-t-2 border-gray-800 flex-wrap md:flex-nowrap">
            <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
            <span class="font-semibold title-font text-white">Misa Sabtu</span>
            <span class="mt-1 text-gray-500 text-sm">Gereja Katolik Santo Barnabas</span>
            </div>
            <div class="md:flex-grow">
            <h2 class="text-2xl font-medium text-white title-font mb-2">Jam 17.00 WIB</h2>
        ...
        <div class="py-8 flex border-t-2 border-gray-800 flex-wrap md:flex-nowrap">
            <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
            <span class="font-semibold title-font text-white">Misa Minggu</span>
            <span class="mt-1 text-gray-500 text-sm">Gereja Katolik Santo Barnabas</span>
            </div>
            <div class="md:flex-grow">
            <h2 class="text-2xl font-medium text-white title-font mb-2">Jam 05.30 WIB</h2>
            <h2 class="text-2xl font-medium text-white title-font mb-2">Jam 07.30 WIB</h2>
            <h2 class="text-2xl font-medium text-white title-font mb-2">Jam 10.00 WIB</h2>
            <h2 class="text-2xl font-medium text-white title-font mb-2">Jam 17.00 WIB</h2>
    ...
    <div class="container px-5 py-24 mx-auto">
        ...
        <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-white">Warta Paroki</h1>
            <div class="h-1 w-20 bg-indigo-500 rounded"></div>
        </div>
        <p class="lg:w-1/2 w-full leading-relaxed text-gray-400 text-opacity-90">Selamat datang di edisi terbaru Warta Paroki Santo Barnabas! Dalam bulan yang penuh berkat ini, kami ingin berbagi berbagai kegiatan dan peristiwa yang mengisi hidup berjemaat. Gereja Santo Barnabas terus menjadi tempat yang penuh kasih dan rohaniah, menginspirasi umat untuk hidup dalam iman dan pelayanan.</p>
        </div>
